...
@living-street-fill: #fefefe;
@pedestrian-fill: #ebebf7;
...
@motorway-width-z10:              2;
@trunk-width-z10:                 2;
@primary-width-z10:               1.8;
@secondary-width-z10:             1.5;
@tertiary-width-z10:              1;

@motorway-width-z11:              2.5;
@trunk-width-z11:                 2.3;
@primary-width-z11:               2.1;
@secondary-width-z11:             1.7;
@tertiary-width-z11:              1.2;
...
@track-width-z13:                 0.7;
@track-grade1-width-z13:          0.7;
@track-grade2-width-z13:          0.7;
...
@lowzoom-halo-color:              black;
@lowzoom-halo-width:              0.4;
...
#roads-casing, #bridges, #tunnels {
  ...
  ::bridges_and_tunnels_background {
    ...
    [zoom >= 16][embankment = 'yes'] {

        a/line-pattern-file: url('symbols/embankment.svg');
        b/line-pattern-file: url('symbols/embankment1.svg');

        a/line-pattern-offset: 5;
        b/line-pattern-offset: -5;

        [zoom >= 17] {
            a/line-pattern-offset: 9;
            b/line-pattern-offset: -9;
        }
        [zoom >= 18] {
            a/line-pattern-offset: 12;
            b/line-pattern-offset: -12;
        }
        [zoom >= 19] {
            a/line-pattern-offset: 15;
            b/line-pattern-offset: -15;
        }
        ...
        [feature = 'railway_monorail'] {
            ...
            a/line-pattern-offset: 2;
            b/line-pattern-offset: -2;

            [zoom >= 17] {
                a/line-pattern-offset: 3;
                b/line-pattern-offset: -3;
            }
            [zoom >= 18] {
                a/line-pattern-offset: 4;
                b/line-pattern-offset: -4;
            }
            [zoom >= 19] {
                a/line-pattern-offset: 5;
                b/line-pattern-offset: -5;
...
#tunnels[zoom >= 10] {
  ...
  ::fill {
    ...
    [feature = 'highway_service'] {
      ...
      [zoom >= 16][service = 'INT-minor'] {
        ...
        [feature = 'highway_busway'] {
            ...
            [zoom >= 17] {
                access/line-color: #a3d1bc;
                access/line-width: 3;
                access/line-dasharray: 10, 6;
    ...
    [feature = 'highway_pedestrian'] {
      ...
      line-pattern-file: url('symbols/pedes-road-16.jpg');
      [zoom >= 17] {
          line-pattern-file: url('symbols/pedes-road.jpg');
      }
    ...
    [feature = 'highway_path'][bicycle != 'designated'][horse != 'designated'] {
      ...
      [zoom >= 15] {
        #roads-fill[zoom >= 15] {
          ...
          background/line-cap: round;
          background/line-join: round;
          background/line-width: @footway-width-z15 + 3 * @paths-background-width;
          background/line-opacity: 0.4;
          [zoom >= 16] {
            background/line-width: @footway-width-z16 + 3 * @paths-background-width;
          }
          [zoom >= 18] {
            background/line-width: @footway-width-z18 + 3 * @paths-background-width;
          }
          [zoom >= 19] {
            background/line-width: @footway-width-z19 + 3 * @paths-background-width;
          }
        }
        line/line-color: #e0afa8;
        [zoom >= 15] {
...
#highway-area-fill {
  ...
  [feature = 'highway_pedestrian'] {
    [zoom >= 15] {
      ...
      polygon-pattern-file: url('symbols/pedes-area.jpg');
      polygon-pattern-comp-op: multiply;
      polygon-pattern-opacity: 0.5;
      polygon-pattern-smooth: 0.2;
    }
  }
