...
@built-up-lowzoom: #ebe6e1;
@residential: #efefef;      // Lch(89,0,0)
...
#landcover[zoom >= 10] {
  ...
  [feature = 'leisure_horse_riding'][zoom >= 13],
  ...
  [feature = 'landuse_orchard'] {
    ...
    [zoom >= 13] {
      polygon-pattern-file: url('symbols/orchard.svg');
      polygon-pattern-alignment: global;
      [way_pixels >= 4]  { polygon-pattern-gamma: 0.75; }
      [way_pixels >= 64] { polygon-pattern-gamma: 0.3;  }
    }
  ...
  [feature="landuse_aquaculture"][zoom >= 9] {
      polygon-fill: #cae3eb;
  ...
  [feature = 'landuse_allotments'] {
    ...
    [zoom >= 13] {
      polygon-pattern-file: url('symbols/allotments.svg');
      polygon-pattern-alignment: global;
      [way_pixels >= 4]  { polygon-pattern-gamma: 0.75; }
      [way_pixels >= 64] { polygon-pattern-gamma: 0.3;  }
    }
  ...
  [feature = 'natural_shrubbery'][zoom >= 15],
  [feature = 'natural_grassland'][zoom >= 3],
  [feature = 'landuse_meadow'][zoom >= 3],
  [feature = 'landuse_grass'][zoom >= 3],
  [feature = 'landuse_village_green'][zoom >= 3] {
    polygon-fill: @grass;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }
  ...
  [feature = 'power_plantsolar'][zoom >= 10],
  [feature = 'power_generator'][zoom >= 10],
  [feature = 'power_substation'][zoom >= 13] {
    polygon-fill: @industrial;
    polygon-comp-op: screen;
    polygon-opacity: 0.5;
    [feature = 'power_plantsolar'] {
        polygon-pattern-file: url('symbols/solar-low-zoom.png');
        polygon-pattern-opacity: 0.5;
        polygon-pattern-comp-op: screen;
        [zoom >= 16] {
            polygon-pattern-opacity: 0.7;
            polygon-pattern-file: url('symbols/solar.png');
        }
        [zoom >= 18] {
            polygon-pattern-opacity: 0.9;
            polygon-pattern-file: url('symbols/solar-z18.png');
        }
    }
  ...
  [feature = 'natural_bare_rock'][zoom >= 3] {
  ...
  [feature = 'natural_shingle'] {
    [zoom >= 3] {
      ...
      [way_pixels >= 64] { polygon-gamma: 0.3;  }
      [zoom >= 13] {
        polygon-pattern-file: url('symbols/scree.svg');
        [way_pixels >= 4]  { polygon-pattern-gamma: 0.75; }
        [way_pixels >= 64] { polygon-pattern-gamma: 0.3;  }
      }
    }
  ...
  [feature = 'natural_sand'][zoom >= 3] {
    polygon-fill: @sand;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }

  [feature = 'natural_heath'][zoom >= 3] {
    polygon-fill: @heath;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }

  [feature = 'natural_scrub'][zoom >= 3] {
    polygon-fill: @scrub;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }

  [feature = 'wetland_swamp'][zoom >= 3] {
    polygon-fill: @forest;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }

  [feature = 'wetland_mangrove'][zoom >= 3] {
    polygon-fill: @scrub;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }

  [feature = 'wetland_reedbed'][zoom >= 3] {
    polygon-fill: @grass;
    [way_pixels >= 4]  { polygon-gamma: 0.75; }
    [way_pixels >= 64] { polygon-gamma: 0.3;  }
  }
  ...
  [feature = 'wetland_marsh'] {
    [zoom >= 3] {
      ...
      [feature = 'wetland_saltmarsh'][zoom >= 13] {
        polygon-pattern-file: url('symbols/salt_dots.svg');
        polygon-pattern-alignment: global;
        [way_pixels >= 4]  { polygon-pattern-gamma: 0.75; }
        [way_pixels >= 64] { polygon-pattern-gamma: 0.3;  }
      }
  ...
  [feature = 'amenity_driver_training'],
...
#landcover-area-symbols {
  ...
  [power='plant'][zoom >= 9] {
      ...
      [zoom >= 13] {
          polygon-pattern-file: url('./symbols/generator_wind_pattern60.png');
          polygon-pattern-alignment: global;
          polygon-pattern-opacity: 0.3;
      }

      [way_pixels >= 4]  { polygon-gamma: 0.75; }
      [way_pixels >= 64] { polygon-gamma: 0.15;  }
  }
